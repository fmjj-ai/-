...
- [ ] Task 7: 质量优化与测试
  - [ ] SubTask 7.1: 前端实现防卡顿策略（视口渲染、骨架屏）
  - [ ] SubTask 7.2: 按《测试方案》完成核心闭环回归测试
  - [ ] SubTask 7.3: 按《审查方案》执行 5 轮自审自测并修复缺陷
- [ ] Task 8: 最终验收与部署准备
  - [ ] SubTask 8.1: 确保所有日志、审计追踪完善
  - [ ] SubTask 8.2: 确认 P0/P1 问题清零，系统达到长期自用标准
